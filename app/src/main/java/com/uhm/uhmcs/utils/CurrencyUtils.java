...
public class CurrencyUtils {
    ...
    public static List<CurrencyBean> getCurrencyList() {
        ...
        //                   显示名称          代码    UI符号   打印缩写
        list.add(new CurrencyBean("(USD)",     "USD",  "$",    "$"));
        list.add(new CurrencyBean("(AED)",   "AED",  "AED",  "AED"));
        list.add(new CurrencyBean("(THB)",     "THB",  "฿",    "THB"));
        list.add(new CurrencyBean("(RUB)",     "RUB",  "₽",    "RUB"));
        list.add(new CurrencyBean("(SGD)", "SGD",  "S$",   "S$"));
        list.add(new CurrencyBean("(MYR)",     "MYR",  "RM",   "MYR"));
        list.add(new CurrencyBean("(EUR)",     "EUR",  "€",    "EUR"));
        list.add(new CurrencyBean("(GBP)",     "GBP",  "£",    "GBP"));
        list.add(new CurrencyBean("(CNY)",   "CNY",  "￥",   "￥"));
